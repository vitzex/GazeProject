...
public class Locomotion
{
    ...
    public float m_SpeedDampTime = 1;
    ...
    public void Do(float speed, float direction)
    {
        ...
        m_Animator.SetFloat(m_SpeedId, 0.3f * speed, 0.3f * speedDampTime, 0.3f * Time.deltaTime);
        m_Animator.SetFloat(m_AgularSpeedId, 0.3f * angularSpeed, 0.3f * angularSpeedDampTime, 0.3f * Time.deltaTime);
